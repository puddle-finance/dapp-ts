                                                                ...
                                                                <CardBody>
                                                                    ...
                                                                    <Center>
                                                                        <Flex >
                                                                            ...
                                                                            <Text ml={'20px'} color={'gold'}>{item.shares} shares</Text>
                                                                    ...
                                                                    <Center>
                                                                        <Flex >
                                                                            ...
                                                                            <Text ml={'20px'} color={'gold'}>{Number(itemPriceTable?.get(item.id)) / (10 ** 9)}</Text>
                                                                            <Text ml={'10px'} color={'gold'}>{item.coin_name} </Text>
                                                                        </Flex>
                                                                    </Center>
                                                                    <Center>
                                                                        <Flex >
